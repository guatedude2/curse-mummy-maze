define('phaser-game', ['exports', 'phaser'], function (exports, Phaser) {
  ...
  PhaserGame.Boot.prototype = {
    ...
    scaleStage:function(){
      ...
      {
        this.scale.scaleMode = Phaser['default'].ScaleManager.SHOW_ALL;
      }
      else
      {
        this.scale.scaleMode = Phaser['default'].ScaleManager.NO_BORDER;
    ...
    if(this.scale.scaleMode==Phaser['default'].ScaleManager.NO_BORDER){
  ...
  var device = Phaser['default'].Device;
  if(device.desktop){
    PhaserGame.screen = "large";
    PhaserGame.gameWidth = 720;
  }

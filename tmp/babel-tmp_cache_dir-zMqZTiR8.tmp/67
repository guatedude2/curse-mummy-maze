...
define("objects/player", ["exports", "phaser"], function (exports, Phaser) {
  ...
  var Player = (function () {
    function Player(map, spriteName, x, y, direction) {
      ...
      this.sprite = this.game.add.sprite(x * TILE_WIDTH + OFFSET.x, y * TILE_HEIGHT + OFFSET.y, spriteName, "down_stand.png");

      this.sprite.animations.add("walk_down", ["down_walk1.png", "down_stand.png", "down_walk2.png", "down_stand.png"], 7, true, false);
      this.sprite.animations.add("walk_up", ["up_walk1.png", "up_stand.png", "up_walk2.png", "up_stand.png"], 7, true, false);
      this.sprite.animations.add("walk_left", ["left_walk1.png", "left_stand.png", "left_walk2.png", "left_stand.png"], 7, true, false);
      this.sprite.animations.add("walk_right", ["right_walk1.png", "right_stand.png", "right_walk2.png", "right_stand.png"], 7, true, false);
    }
    ...
    _createClass(Player, {
      ...
      lookAt: {
        value: function lookAt(direction) {
